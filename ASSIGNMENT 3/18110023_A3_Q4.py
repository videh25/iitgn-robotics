...
RRPVar = [[0, 0, 10, np.pi/2], [10, 5, 0, 0], [20, 0, 0, 0]]
nr = 3 #no of joints in RRP
a = Tmat(nr, RRPVar)
JR = Rev_Jacob(3, a, [0, 0, 1]) 
print("The Jacobian of RRP will be:",JR)

SCARAVar = [[0, 0, 5, np.pi/2], [20, 0, 0, np.pi], [10, 0, 0, 0], [0, 0, 30, np.pi/4]];
ns = 4 #number of joints in SCARA
a1 = Tmat(4, SCARAVar)
JS = Rev_Jacob(4, a1)
print("The Jacobian of SCARA will be:",JS)

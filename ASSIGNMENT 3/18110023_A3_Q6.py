...
Q6 = [[0, -np.pi/4, 10, (np.pi*4)/3], [10, 0, 10, np.pi/4], [10, 0, 0, np.pi/2], [0, np.pi/4, 0, 0], [0, -np.pi/4, 0, 0], [0, 0, 10, np.pi/4]];
a3 = Tmat(6,Q6)
b3 = Rev_Jacob(6, a3,[0,0,0,0,0,0])
print("Jacobian for this will be",b3)
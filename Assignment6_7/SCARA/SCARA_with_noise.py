...
class SCARAManipulator:
    ...
    def apply_torques(self, tor_tup):   #Updates the state of system and return it
        ...
        q_dot2 = self.q_dot2_array.subs([(self.q_symbols[0], q1),
                        ...
                        (self.tau_symbols[0], tor_tup[0] + np.random.normal(0,0.1)),
                        (self.tau_symbols[1], tor_tup[1] + np.random.normal(0,0.1)),
                        (self.tau_symbols[2], tor_tup[2] + np.random.normal(0,0.1)),

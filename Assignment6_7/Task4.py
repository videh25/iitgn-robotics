...
import numpy as np
from SCARA.SCARA_false_link_wrapper import*
from SCARA.SCARA import*


arko = SCARAWrapper(SCARAManipulator())
print('MSG:: SCARAManipulator initialised, named arko')
...
arko.run()
print()
arko.Real_Manipulator.fig.canvas.manager.set_window_title('Your own SCARA Manipulator: ARKO')
...
ee_pos_mat_pd = []
arko.Real_Manipulator.ax.plot((0.40,0.40),(0.06,0.01), (-arko.l1+0.1,-arko.l1+0.1),color = 'g', alpha=0.5)

...
def end_position(Q):
    ...
    #Frame transform 2_3
    R2_3=np.array([[np.cos(q3),-np.sin(q3),0],[np.sin(q3),np.cos(q3),0],[0,0,1]])
    d2_3=np.array([[l2],[0],[0]])
    H2_3=np.zeros([4,4])
...
def jacobian(Q):
    ...
    J0_P[0:3,2:3]=np.matmul(skew_z3,np.subtract(Op,O3))
    J0_P[3:6,0:1]=z1
    J0_P[3:6,1:2]=z2
    J0_P[3:6,2:3]=z3

    print("Jacobian of Elbow : \n")
    print(J0_P)
    return J0_P

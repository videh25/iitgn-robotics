...
def end_position(Q):
    ...
    #Frame transform 1_2
    R1_2=np.matmul(np.array([[1,0,0],[0,0,-1],[0,1,0]]),np.array([[np.cos(q2),-np.sin(q2),0],[np.sin(q2),np.cos(q2),0],[0,0,1]]))
    d1_2=np.array([[0],[-l2],[l1]])
    H1_2=np.zeros([4,4])
    ...
    #Frame transform 2_3
    R2_3=np.array([[0,0,1],[0,1,0],[-1,0,0]])
    d2_3=np.array([[d3],[0],[0]])
    H2_3=np.zeros([4,4])
